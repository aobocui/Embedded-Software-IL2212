 ...
 * Changed by Aobo Cui according to the pointer types.
 ...
 */
/*
void printAsciiHidden(double* image, int x_dim, int y_dim,
		      int x_pos, int y_pos,
		      int size, double gray_value) {
  int k = 0;
  int l = 0;
  for(k = 0; k < y_dim; k++) {
    for(l = 0; l < x_dim; l++) {	
